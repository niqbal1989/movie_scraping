...
movie_OWBO = movie_OWBO.replace('Harry Potter and the Deathly Hallows Part 2', 'Harry Potter and the Deathly Hallows: Part 1')
movie_stars_df = movie_stars_df('Tron', 'Tron Legacy')
